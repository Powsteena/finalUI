...
//   // Effect for continuous location tracking
//   useEffect(() => {
//     let watchId;
...
//         await fetch('http://localhost:5000/api/ride-request/driver/location', {
//           method: 'POST',
//           headers: {
...
//         // Only fetch address if it hasn't been set yet or if location has changed significantly
//         if (!address) {
//           fetchAddress(latitude, longitude);
//         }
//       } catch (error) {
...
//       }
//     };
//   }, [isAvailable, map, locationMarker, address]);
