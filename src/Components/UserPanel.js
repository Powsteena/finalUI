      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white shadow-xl rounded-3xl overflow-hidden">
              <div className="bg-black px-8 py-6">
                <h2 className="text-2xl font-bold text-yellow-500">Schedule Your Ride</h2>
              ...
              <form onSubmit={handleScheduleRide} className="p-8 space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    ...
                    <div className="relative">
                      <MapPin className="absolute left-4 top-3 text-yellow-500" size={20} />
                      <input
                        type="text"
                        value={pickup}
                        onChange={(e) => setPickup(e.target.value)}
                        className="w-full pl-12 pr-4 py-3 bg-white border-2 border-black rounded-xl focus:outline-none focus:ring-2 focus:ring-yellow-500"
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="space-y-4">
                    ...
                    <div className="relative">
                      <Car className="absolute left-4 top-3 text-yellow-500" size={20} />
                      <select
                        value={vehicleType}
                        onChange={(e) => setVehicleType(e.target.value)}
                        className="w-full pl-12 pr-4 py-3 bg-white border-2 border-black rounded-xl focus:outline-none focus:ring-2 focus:ring-yellow-500 appearance-none"
                      >
                        <option value="car">Car</option>
                        <option value="van">Van</option>
                        <option value="bike">Bike</option>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="relative">
                      <Users className="absolute left-4 top-3 text-yellow-500" size={20} />
                      <input
                        type="number"
                        value={numPassengers}
                        onChange={(e) => setNumPassengers(e.target.value)}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="relative">
                      <Calendar className="absolute left-4 top-3 text-yellow-500" size={20} />
                      <input
                        type="datetime-local"
                        value={scheduledDateTime}
                        onChange={(e) => setScheduledDateTime(e.target.value)}
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-black hover:bg-yellow-500 text-white hover:text-black font-medium py-4 px-6 rounded-xl transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2"
                >
                  {loading ? 'Scheduling...' : 'Schedule Ride'}
                </button>
              </form>
        ...
        {activeTab === 'myRides' && (
          <div className="max-w-4xl mx-auto bg-white shadow-xl rounded-3xl overflow-hidden">
            <div className="bg-black px-8 py-6">
              <h2 className="text-2xl font-bold text-yellow-500">My Rides</h2>
        ...
        {activeTab === 'accepted' && (
          <div className="max-w-4xl mx-auto bg-white shadow-xl rounded-3xl overflow-hidden">
            <div className="bg-black px-8 py-6">
              <h2 className="text-2xl font-bold text-yellow-500">Accepted Rides</h2>
